...
var KeyDisplay = /** @class */ (function () {
  ...
  KeyDisplay.prototype.updatePosition = function () {
    this.map.get(exports.W).style.top = "".concat(
      window.innerHeight - 150,
      "px"
    );
    this.map.get(exports.A).style.top = "".concat(
      window.innerHeight - 100,
      "px"
    );
    this.map.get(exports.S).style.top = "".concat(
      window.innerHeight - 100,
      "px"
    );
    this.map.get(exports.D).style.top = "".concat(
      window.innerHeight - 100,
      "px"
    );
    this.map.get(exports.SHIFT).style.top = "".concat(
      window.innerHeight - 100,
      "px"
    );
